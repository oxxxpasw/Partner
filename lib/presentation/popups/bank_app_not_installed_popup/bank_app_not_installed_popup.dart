...
@RoutePage()
class BankAppNotInstalledPopup extends StatelessWidget {
  const BankAppNotInstalledPopup({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          context.tr(LocaleKeys.sbp_appNotInstalled),
        ),
        Padding(
          ...
          child: FilledButtonWithArrow(
            ...
            label: Text(
              context.tr(LocaleKeys.sbp_appNotInstalledConfirm),
            ),
          ),
        ),
      ],

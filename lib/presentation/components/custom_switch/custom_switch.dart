...
class CustomSwitch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final config = this.config ?? _SwitchConfigDefault(context);
...
class _MaterialSwitchState extends State<_MaterialSwitch>
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    if (isInteractive) {
      position
        ...
        ..reverseCurve = null;
      final double delta =
          details.primaryDelta! / widget.config.trackInnerLength;
  ...
  Widget build(BuildContext context) {
    ...
    final SwitchConfig switchConfig = widget.config;
    final SwitchThemeData defaults = _SwitchDefaults(context);
        ...
        child: Opacity(
          ...
          child: buildToggleable(
            ...
            painter: _painter
              ...
              ..trackInnerLength = widget.config.trackInnerLength
  ...
  void _paintThumbWith(
    ...
    try {
      ...
      if (thumbIcon != null && thumbIcon.icon != null) {
        ...
        final double iconSize = thumbIcon.size ?? _SwitchConfigDefault.iconSize;
...
class _SwitchDefaults extends SwitchThemeData {
...
abstract class SwitchConfig {
  ...
  double get trackInnerLength;
}

class _SwitchConfigDefault extends SwitchConfig {
  _SwitchConfigDefault(this.context) : _colors = Theme.of(context).colorScheme;
  ...
  @override
  double get activeThumbRadius => 7.0;
  ...
  @override
  double get inactiveThumbRadius => activeThumbRadius;

  @override
  double get pressedThumbRadius => activeThumbRadius;

  @override
  double get switchHeight => size.height;

  @override
  double get switchHeightCollapsed => size.height;

  @override
  double get switchWidth => trackWidth;

  @override
  double get thumbRadiusWithIcon => activeThumbRadius;
  ...
  @override
  Size get transitionalThumbSize =>
      Size(activeThumbRadius * 2, activeThumbRadius * 2);
  ...
  @override
  Size get size => const Size(42, kMinInteractiveDimension - 8.0);

  @override
  Curve get curve => Curves.easeIn;

  @override
  Curve get reverseCurve => Curves.easeOut;

  @override
  double get trackInnerLength => size.width - trackHeight;
}

...
class OnBoardingPage1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final renderBox = OnboardingKeys.unpaidOrderActionButtonKey.currentContext
        ...
        children: [
          Positioned(
            ...
            child: OnboardingTooltip(
              title: Text(
                context.tr(LocaleKeys.unpaidOrderOnboarding_page1_title),
              ),

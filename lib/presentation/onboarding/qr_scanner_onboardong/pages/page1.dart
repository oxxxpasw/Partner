...
class OnBoardingPage1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final renderBox = OnboardingKeys.scannerBannerKey.currentContext
    ...
    final rect = Rect.fromCenter(
      center: renderRect.center,
      width: renderRect.width - AppInsets.padding16 * 2,
        ...
        children: [
          Positioned(
            ...
            child: OnboardingTooltip(
              title: Text(
                context.tr(LocaleKeys.onboarding_page7_title),
              ),

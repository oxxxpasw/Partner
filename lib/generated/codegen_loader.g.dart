...
class CodegenLoader extends AssetLoader{
  ...
  "messages": {
    "success": {
      ...
      "successInventarization": "Документ инвентаризации успешно создан",
      "successDiscarding": "Документ списания успешно создан",
  ...
  "cart": {
    ...
    "cancelOrderQuestion": "Вы действительно хотите прервать списание/инвентаризацию?",
    "confirmOrderQuestion": "Завершить покупку?",
    "cancelInventoryQuestion": "Вы действительно хотите прервать инвентаризацию?",
    "confirmInventoryQuestion": "Завершить инвентаризацию?",
    "cancelDiscardingQuestion": "Вы действительно хотите отменить списание?",
    "confirmDiscardingQuestion": "Завершить списание товаров?",
    "storeNotSelected": {
    ...
    "confirmCreation": "Вы действительно хотите отправить документ?"
  },
  "userProfile": {
    "label": "Профиль",
    ...
    "navLabels": {
      ...
      "requests": "Мои заявки на подключение",
    ...
    "goToWebsite": {
      "title": "Хотите приобрести кофемашину и/или микромаркет?"
    }
  },
  "personalData": {
    "label": "Личные данные",
    ...
    "birthDay": {
      "label": "Дата рождения",
      "hint": "Дарим бонусы в день рождения"
    },
    "phone": {
      "label": "Телефон",
      "hint": "Номер телефона"
  ...
  "fridge": {
    ...
    "haveProducts": "Выбрать точку",
    "permissionRequest": {
      "title": "Доступ к камере запрещен",
      "message": "Чтобы настроить доступ к камере, перейдите в настройки и включите камеру для приложения CoffeeSwipe",
      "cancelLabel": "Отмена",
  ...
  "orderDetails": {
    ...
    "microMarket": "Адрес",
    "purchase": "Покупка",
    "unpaidPurchase": "Покупка • Не оплачена",
    "cancelOrderDialog": {
  ...
  "auth": {
    ...
    "openWithoutRegMessage": "Для открытия микромаркета необходимо авторизироваться"
  },
  "reportProblem": {
  ...
  "splash": {
    "update": {
      "label": "Пора\n   обновляться!",
      "title": "Федя ждет вас!",
      "descr": "Похоже, ваша версия приложения устарела, обновите его, чтобы продолжить пользоваться",
      "action": "Обновить"
    },
    "error": {
      "label": "Скоро всё\n      починим!",
      "title": "Федя уже разбирается в ситуации!",
      "descr": "Похоже, у нас случились технические неполадки, попробуйте зайти позже"
    }
  },
  "map": {
    "label": "Карта"
  ...
  "bonusProgramInfoScreen": {
    ...
    "infoDialog": {
      "message": "Начислим 5% от каждой покупки, ими можно оплатить до 100%.\n\nВы копите баллы отдельно у каждого партнера и можете тратить их в рамках его точек. Ориентируйтесь на логотипы и точно не ошибетесь!",
      "action": "Понятно"
    },
  ...
  "homeScreen": {
    ...
    "emptyView": {
      "createRequest": {
        "title": "У вас пока что нет торговых точек, если у вас уже есть кофемашины и вы хотите оставить заявку на их подключение - нажмите сюда:",
        "action": "Войти в ЛК Vendista"
      },
      "goToWebsite": {
        "title": "Если вы хотите приобрести кофемашину и/или микромаркет - оставьте заявку на сайте:",
        "action": "Оставить заявку"
      }
    },
    "hasRequestsView": {
      "title": "Ожидайте рассмотрения заявки",
      "action": "Посмотреть мои заявки"
    },
    "view": {
      "divisionCard": {
        "title": "{address} ({name})",
  ...
  "divisionDetails": {
    ...
    "reviews": "Отзывы",
    "inventarization": {
      "question": "Вы действительно хотите начать инвентаризацию?"
    },
    "fridgeOpenedMessage": "Открыто еще {} секунд",
    "report": "Отчет",
    "events": "События",
    "lastVal": "Посл.: {}",
    "temp": "Температура"
  },
  "createVendistaRequestScreen": {
    "title": "Заявка на подключение",
    "vendistaAuthScreen": {
      "login": "Логин",
      "password": "Пароль",
      "title": "Доступ к Vendista",
      "description": "Введите логин и пароль от личного кабинета Vendista, чтобы отобразить ваши кофемашины",
      "action": "Продолжить"
    },
    "vendistaChooseIDScreen": {
      "title": "Выберите кофемашины для подключения и нажмите «Подключить выбранные»",
      "description": "id можно найти в лк Vendista, вкладка «Терминалы»",
      "chooseAll": "Выбрать все",
      "action": "Подключить выбранные",
      "error": {
        "message": "Похоже, у нас возникли проблемы при загрузке ваших терминалов, но вы все равно можете оставить заявку, мы свяжемся с вами для уточнения деталей"
      }
    },
    "successScreen": {
      "message": "Готово! Ваша заявка отправлена, вы можете отслеживать ее статус в Профиле в разделе «Мои заявки на подключение»",
      "action": "Здорово!"
    }
  },
  "vendistaRequestsScreen": {
    "title": "Мои заявки на подключение",
    ...
    "requestItem": {
      ...
      "action": "Введите данные для активации работы -->"
    },
    "requestStatus": {
      "underReview": "На рассмотрении",
      "verified": "Прошла проверку",
      "rejected": "Отклонена",
      "dataSent": "Данные отправлены",
      "closed": "Закрыта"
    }
  },
  "vendistaRequestDetailsScreen": {
    "title": "Активация (id: {})",
    "successMessage": {
      "message": "Данные отправлены, ожидайте рассмотрения, мы свяжемся с вами",
      "action": "Здорово!"
    },
    "form": {
      ...
      "errors": {
        "empty": {
          "orgType": "Выберите один из вариантов"
        },
      ...
      "orgData": {
        ...
        "vat": {
          "label": "Ставка НДС",
          "hint": "Выберите ставку"
        }
      },
      "sellingPointData": {
        "title": "Торговая точка",
        "description": "На основе указанных данных будет создана торговая точка в приложении",
        "city": {
          "label": "Город",
          "hint": "Выберите город"
        },
        ...
        "name": {
          "label": "Название (местоположение/адрес)",
          "hint": "ДЦ на Октябрьской"
        },
        "latitude": {
          "label": "Широта",
          "hint": "00.000000"
  ...
  "reportDataScreen": {
    "errorFormatText": "Недопуст. значение",
    "chooseAnotherPeriod": "Попробуйте выбрать другой период"
  },
  "unitEventsScreen": {
    "title": "События",
    "interval": "за последние 48 часов"
  },
  "unitTempScreen": {
    "title": "Температура",
    "interval": "за последние 48 часов"
